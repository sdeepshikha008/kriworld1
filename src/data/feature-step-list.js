...
const FeatureStepList = [
  ...
  {
    id: 8,
    featureImg: featureStepImg8,
    stepNumber: '08',
    title: 'We are responsive and flexible',
    description:
      'Some people will tell you there are four while others may tell then it is just like any other process.',
  },
];
...
export default FeatureStepList;
