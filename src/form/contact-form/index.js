        ...
        <div className="row row-gap">
          ...
          <div className="col-sm-12">
            <div className="input-control">
              ...
              <input type="tel" name="PhoneNumber" value={inputs.PhoneNumber || ""} onChange={handleChange} placeholder="Phone Number"/>
          ...
          <div className="col-sm-12">
            <div className="input-control">
              ...
              <input type="tel" name="EnquiryType" value={inputs.EnquiryType || ""} onChange={handleChange} placeholder="Enquiry Type"/>
          ...
          <div className="col-sm-12">
            <div className="input-control">
              <label>Message :</label>
              <textarea rows={5} name="Message" value={inputs.Message || ""} onChange={handleChange} placeholder="Enquiry Description"/>
              {errors.Message && <span className="error">{errors.Message}</span>}
            </div>
          </div>
          <div className="col-sm-12">
            <div className="checkbox-control">
              <input type="checkbox" name="Term of Service" checked={inputs["Term of Service"] || false} onChange={handleChange}/>{" "}
              I agree to talk about my project with Hi-soft
            </div>
            {errors["Term of Service"] && (
                <span className="checkbox-error">{errors["Term of Service"]}</span>
              )}
          </div>
          <div className="col-sm-12">
            <div className="input-control">
